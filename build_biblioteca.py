...
CASOS = [
    ...
    caso(slug="leptospirose", titulo="Febre de abril",
         ...
         especialidade="Clínica médica · Emergência", minutos=45, decisoes=8,
         desfechos=3, nivel="os dois", cor="azul", capa="", arquivo="leptospirose.html?v=20260924-viva"),
    caso(slug="endocardite", titulo="Pequenos sinais",
         ...
         desfechos=3, nivel="os dois", cor="vermelho", capa="", arquivo="endocardite.html?v=20260924-viva"),
    caso(slug="adrenal", titulo="Mais escura a cada verão",
         ...
         desfechos=3, nivel="os dois", cor="ocre", capa="", arquivo="adrenal.html?v=20260924-viva"),
