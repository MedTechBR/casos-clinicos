...
CASOS = [
    caso(slug="pulmao_rim",
         ...
         capa="cena_admissao.jpg", arquivo="pulmao-rim.html?v=20260922-tabelas"),
    ...
    caso(slug="cocaina_levamisol", titulo="À flor da pele",
         ...
         capa="../../cocaina_levamisol/img/cena.png", arquivo="cocaina-levamisol.html?v=20260922-tabelas"),
