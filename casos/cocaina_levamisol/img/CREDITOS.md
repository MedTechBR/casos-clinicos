...
Ilustração gerada por IA para paciente ficcional, em 6 de setembro de 2026. Uso exclusivamente editorial (capa e contextualização). Não documenta achados de exame físico nem representa exame diagnóstico.
...
- **Púrpura — outro paciente**: Hektor. CC BY-SA 3.0. [Fonte e licença](https://commons.wikimedia.org/wiki/File:Purpura.jpg). Arquivo sem alterações. Uso comparativo; não é exame do paciente ficcional.

## Ampliação radiológica

- `rx_torax_normal.jpg` — Mikael Häggström. [Fonte](https://commons.wikimedia.org/wiki/File:Normal_posteroanterior_(PA)_chest_radiograph_(X-ray).jpg) · [CC0](https://creativecommons.org/publicdomain/zero/1.0/). redução de resolução da versão já usada no acervo. Imagem de outro paciente para uso ilustrativo/comparativo.
- `us_rim.jpg` — Kristoffer Lindskov Hansen, Michael Bachmann Nielsen e Caroline Ewertsen. [Fonte](https://commons.wikimedia.org/wiki/File:Normal_adult_kidney.jpg) · [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). recorte anterior removeu a medida numérica; cálipers e asteriscos originais preservados. Imagem de outro paciente para uso ilustrativo/comparativo.
