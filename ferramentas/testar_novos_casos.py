...
CONFIG={
 'west_nile': dict(full={'ex1':['Hemograma','Eletrólitos e função renal','Glicemia','Hemoculturas iniciais'], 'ex2':['Líquor: celularidade, proteína, glicose e Gram','PCR para HSV e VZV no líquor','Eletroneuromiografia','Ressonância de encéfalo e medula'], 'ex3':['IgM para vírus do Nilo Ocidental em soro e líquor','Nova eletroneuromiografia','Nova PCR para HSV no líquor','Sorologia para encefalite de Saint Louis']}, minimal={'ex1':['TSH'],'ex2':['Amônia'],'ex3':['Cobre sérico']}),
 'cocaina_levamisol': dict(full={'p1':['Hemograma diferencial','Hemoculturas iniciais','Coagulograma','Creatinina inicial'],'p2':['Biópsia cutânea','Sedimento urinário','Creatinina de reavaliação','Anti-MPO'],'p3':['Biópsia renal','Creatinina atual','Benzoilecgonina urinária','Levamisol urinário por LC-MS/MS']}, minimal={'p1':['Lactato'],'p2':['Complemento C3'],'p3':['Anti-MBG']})}
report={}
...
(ROOT/'saida'/'revisao'/('novos-casos-qa-smoke.json' if '--smoke' in sys.argv else 'novos-casos-qa.json')).write_text(json.dumps(report,ensure_ascii=False,indent=2))
